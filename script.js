...
const consent = {
  ...
  stimulus: `
    ...
    <p>Participation in this study will involve completing a computer-based task involving actions about experimental stimuli, followed by a short survey. Specifically, you will be presented with sentences, which you will be requested to physically approach (by zooming in into the sentence) or to physically avoid (by zooming away from the sentence). These approach-avoidance movements will be implemented by using keys on your keyboard. Your involvement will require about 9 minutes. You will receive £2.22 GBP in exchange for your participation. To participate, you need to use a computer.</p>
  ...
  stimulus: `
    <div style="max-width:800px; margin:auto; text-align:justify;">
      ...
      <div style="border: 2px solid red; border-radius:6px; padding:15px 20px; margin:10px auto; max-width:650px; background-color:#fff5f5;">
        <p style="margin:0;">The presentation phase will now begin and will take around 3-4 minutes. We remind you to pay close attention to the material that will be presented as you will be asked to answer questions about it later in this study. It is very important that you read each trivia statement in full.</p>
      </div>
      <p style="margin-top:20px;">Press the 'Next' button to continue.</p>
    </div>
  `,
...
const instructions10 = {
  ...
  stimulus: `
    ...
    <div style="max-width:800px; margin:auto; text-align:justify;">
      <p>In this task, you will be presented with all the statements you read in the previous part of the study. Your task will be to judge each statement truth. To avoid compromising the study results, we ask that you do not search for information related to the statements during the study.</p>
    </div>
    <div style="max-width:800px; margin:auto; text-align:center;"> 
      <p style="margin-top:20px;">Press the 'Next' button to continue.</p>
    </div>
...
// ------------------------------
const rating_trials = {
  timeline: jsPsych.randomization.shuffle(stimuli8).map(stim => ({
