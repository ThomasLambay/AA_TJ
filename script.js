...
const consent = {
  ...
  stimulus: `
    ...
    <p>Participation in this study will involve completing a computer-based task involving actions about experimental stimuli, followed by a short survey. Specifically, you will be presented with sentences, which you will be requested to physically approach (by zooming in on the sentence) or to physically avoid (by zooming out from the sentence). These approach-avoidance movements will be implemented by using keys on your keyboard. Your involvement will require about 9 minutes. You will receive £2.22 GBP in exchange for your participation. To participate, you need to use a computer.</p>
